...
router.post('/', auth, tenantResolver, async (req, res) => {
  ...
  try {
    ...
    console.log('🔍 Looking for format:', req.body.output_format_id);
    ...
    console.log('💾 Inserting feed doc...');
    ...
    console.log('✅ Feed saved:', savedFeed);
...
// ─────────────────────────────────────────────
// POST /api/output-feeds/:id/build — Step 2
// ─────────────────────────────────────────────
