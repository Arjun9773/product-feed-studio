...
return (
  <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} className="space-y-6 px-4 sm:px-0">
    
    {/* Header Section */}
    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
      <div>
        <h1 className="text-xl sm:text-2xl font-bold text-foreground">Title Optimization</h1>
        <p className="text-muted-foreground text-sm mt-1">
          Your product name optimization process is shown below
        </p>
      </div>
      <Button 
        className="bg-primary text-primary-foreground gap-2 w-full sm:w-auto justify-center" 
